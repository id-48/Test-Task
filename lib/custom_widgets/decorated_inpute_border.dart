...
class DecoratedInputBorder extends InputBorder {
  ...
  void paint(Canvas canvas, Rect rect,
    ...
    child.paint(canvas, rect, gapStart: gapStart,
        gapExtent: gapExtent,
  ...
  bool operator ==(Object other) {
    ...
    return other is DecoratedInputBorder && other.borderSide == borderSide &&
        other.child == child && other.shadow == shadow;
  }
  ...
  String toString() {
    return '${objectRuntimeType(
        this, 'DecoratedInputBorder')}($borderSide, $shadow, $child)';
  }
}